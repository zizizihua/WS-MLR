...
class CSRA_Module(nn.Module): # one basic block 
    def __init__(self, input_dim, num_classes, T, lam):
        super(CSRA_Module, self).__init__()
...
class MHA(nn.Module):  # multi-head attention
    ...
    def __init__(self, num_heads, lam, input_dim, num_classes):
        ...
        self.multi_head = nn.ModuleList([
            CSRA_Module(input_dim, num_classes, self.temp_list[i], lam)
...
class CSRA(nn.Module):
    def __init__(self, num_heads, lam, num_classes, input_dim=2048):
